...
@section("content")
    <form action="{{url('/categories')}}" method="POST" autocomplete="off" novalidate>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="mt-2">
                    <x-input label="Kategori metni" placeholder="Kategori metin giriniz" field="metin"/>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="mt-2">
                    <x-input label="Kategori slug" placeholder="Kategori slug kısmı giriniz" field="slug"/>
                </div>
            </div>
            <div class="col-lg-6">
